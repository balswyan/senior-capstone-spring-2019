...
def clean_csv(file, output=None):
    ...
    dframe = dframe[~dframe['category'].str.contains('shopping')] #Filter out shopping
    ...
    dframe = dframe[~dframe['url'].str.contains(r'canvas[.].*?[.]edu|blackboard[.].*?[.]edu')] #Filter out Canvas and Blackboard
